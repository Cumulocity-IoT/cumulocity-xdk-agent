...
static ConfigLine_T ConfigStructure[ATT_IDX_SIZE] = {
		...
		{ A10Name, BOOL_TO_STR(DEFAULT_GYRO_ENABELED), CFG_FALSE, CFG_FALSE, AttValues[10] },
		{ A11Name, BOOL_TO_STR(DEFAULT_MAG_ENABELED), CFG_FALSE, CFG_FALSE, AttValues[11] },
		{ A12Name, BOOL_TO_STR(DEFAULT_ENV_ENABELED), CFG_FALSE, CFG_FALSE, AttValues[12] },
